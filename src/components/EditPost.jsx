...
export default function EditPost({post, onSave=null}) {
	...
	const [validation, setValidatiom] = useState({});
	...
	return (<>
		<form action={handleSubmit}>
			...
			<div className="flex justify-between flex-row-reverse">
				<button className="medium" type="submit" tabIndex="3">Save</button>
				<button className="medium" onClick={onCancel} tabIndex="4">Cancel</button>
			</div>
		</form>
	</>);
};